...
const BINDINGS: { keys: string[]; action: string }[] = [
  ...
  { keys: ['g'], action: 'Top of list' },
  { keys: ['G'], action: 'Bottom of list' },
  { keys: ['Enter'], action: 'Open / focus reader' },
  { keys: ['J', ']'], action: 'Next feed or view' },
  { keys: ['K', '['], action: 'Previous feed or view' },
  { keys: ['m'], action: 'Toggle read / unread' },
  { keys: ['s'], action: 'Toggle star' },
  { keys: ['A'], action: 'Mark current feed or view read' },
  { keys: ['r'], action: 'Refresh current feed' },
  { keys: ['R'], action: 'Refresh all feeds' },
